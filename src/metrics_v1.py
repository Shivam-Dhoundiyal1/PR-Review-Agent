"""Calculate V1 metrics from the separate V1 policy results."""
...
INPUT_PATH = PROJECT_ROOT / "results" / "v1_policy_results.json"
OUTPUT_PATH = PROJECT_ROOT / "results" / "v1_metrics.json"
...
def calculate_policy_metrics(policy_result):
    ...
    for case in cases:
        ...
        predicted_major = case["posterior"]["Major Defect"] / 100
        actual_major = float(case["actual_state"] == "Major Defect")
        brier_total += (predicted_major - actual_major) ** 2
    ...
    return {
        ...
        "confusion_matrix": policy_result["confusion_matrix"],
        ...
        "major_defect_brier_score": round(brier_total / len(cases), 6),
    }
...
def main():
    ...
    print(f"Saved V1 metrics to {OUTPUT_PATH}")
